...
$(document).ready(function () {
    ...
    const games = [
        {
            title: "Fattening",
            description:
                "Вы попадаете в дом с призраком. Но не совсем обычным... Ваша задача выжить и пройти весь сюжет до конца.",
            platform: "Windows",
            year: "2018",
        ...
        },
        {
            title: "Star Meadow",
            description:
                "Соберите все звездочки, не дав себя поймать. Но помните, что чем больше звезд вы соберете - тем сложнее будет идти.",
            platform: "Windows",
            year: "2019",
        ...
        },
        {
            ...
            description:
                "Ковбой Дикого Запада и его жена человеколягушка. А еще она тянет в рот все что попадается под руку, так что ваша задача убирать с ее пути все, что не является насекомым.",
            platform: "Windows",
            year: "2021",
        ...
        },
        {
            ...
            description:
                "Космический шутер, где из подбитых вражеских кораблей выпадают булочки. Вам предстоит плавно раскормить главную героиню в одиночку или раскормить еще и ее подруг.",
            platform: "Windows",
            year: "2019",
        ...
        },
        {
            title: "FattFatt",
            description:
                "Главная героиня попадает в мир, целиком и полностью состоящий из еды. Ее задача - выбраться оттуда и нерастолстеть до предела...",
            platform: "Windows",
            year: "2018",
            genres: ["Аркада", "Инди"],
            categories: ["short", "arcade", "original"],
        ...
        },
        {
            title: "Feeding Lila",
            description:
                "Лила попала в лапы монстра, заставляющего ее набирать вес в считанные секунды. Ваша задача балансировать между показателями, не давая им переполняться время от времени.",
            platform: "Windows",
            year: "2019",
            genres: ["Аркада", "Инди"],
            categories: ["short", "arcade", "original"],
        ...
        },
        {
            ...
            description:
                "Некто по имени Мисс Тарабан получает приглашение на должность повара. Говорят, что все дело в ее сверх калорийной еде...",
            platform: "Windows",
            year: "2019",
            genres: ["Аркада", "Инди"],
            categories: ["short", "arcade", "original"],
        ...
        },
        {
            ...
            description:
                "Вы - фея Ханса и ваша задача успеть на фестиваль. Но вот беда, волшебный лес наводнили гоблины. Хорошо, что любимая клубника в избытке, правда от нее Ханса быстро набирает вес...",
            platform: "Windows",
            year: "2018",
            genres: ["RPG", "Инди"],
        ...
        },
        {
            title: "Amoeblaster",
            description:
                "Собирайте четыре в ряд и грудь персонажа будет расти - все просто! Главное не сбиваться из-за растущего ритма и сложности.",
            platform: "Windows",
            year: "2019",
            genres: ["Казуал", "Инди"],
            categories: ["short", "arcade", "original"],
        ...
        },
        {
            ...
            description:
                "Пародия на FNAF, но вместо привычных аниматроников полные женоподобные роботы...",
            platform: "Windows",
            year: "2020",
        ...
        },
        {
            title: "Lickety Split",
            description:
                "Вы - мороженщик, но ваш продукт имеет интересную особенность: от него быстро набираешь вес.",
            platform: "Windows",
            year: "2020",
            genres: ["Казуал", "Инди"],
            categories: ["short", "arcade", "original"],
        ...
        },
        {
            ...
            description:
                "Вы простой рыцарь, удостоенный чести в течении трех дней после непростых вылазок в вражеский замок кормить королеву найденной едой. Чем больше еды вы принесете, тем толще она станет...",
            platform: "Windows",
            year: "2021",
        ...
        },
        {
            ...
            description:
                "Вы - безымянный герой, который был нанят нянькой для Зои ее матерью. Зоя весьма необычная девушка, о чем вы скоро сами поймете...Скачивая этот набор игр, вы подтверждаете, что вам исполнилось 18 лет!",
            platform: "Windows",
            year: "2020",
        ...
        },
        {
            ...
            description:
                "Тетрис с элементами набора веса. Больше счет - больше живот!",
            platform: "Windows",
            year: "2020",
            genres: ["Казуал", "Инди"],
            categories: ["short", "arcade", "original"],
        ...
        },
        {
            ...
            description:
                "Персонаж влюблен в : девушку выразительных форм. Как с неба полетели шоколадки. Поймай их всех! Скачивая эту игру, вы подтверждаете, что вам исполнилось 18 лет!",
            platform: "Windows",
            year: "2021",
            genres: ["Казуал", "Инди"],
            categories: ["short", "arcade", "original"],
        ...
        },
        {
            ...
            description:
                "Вы работаете на фабрике, превращающей желе с помощью машины вкусов в съедобную вкусность. Рутина подходит к концу, когда к вам наведывается стажер, которую вы решаетесь накормить...",
            platform: "Windows",
            year: "2019",
            genres: ["Казуал", "Инди"],
            categories: ["short", "arcade", "original"],
        ...
        },
        {
            title: "Fattaker",
            description:
                "Вы мечтаете о гореме из роскошных полных дьяволиц. Пройдите сложные головоломки, подбирайте правильно слова и следите, как ваша дьяволица растет как на дрожах!",
            platform: "Windows",
            year: "2021",
        ...
        },
        {
            ...
            description:
                "Вы эльфийка, мечтающая раскормить добрую половину города, зная секреты Ауры набора веса. Впрочем, в этом стремлении вы будете не одиноки. Знание английского необходимо!",
            platform: "Windows",
            year: "2021",
        ...
        },
        {
            ...
            description:
                "Кормите демона блинчиками и следите за растущим животом. Избегайте огоньков!",
            platform: "Windows",
            year: "2021",
            genres: ["Аркада", "Инди"],
            categories: ["short", "arcade", "original"],
        ...
        },
        {
            ...
            description:
                "Вы играете за милую пышку - курьера. Пройдите через множество препятствий и доставьте заказ!",
            platform: "Windows",
            year: "2019",
            genres: ["Квест", "Инди"],
            categories: ["short", "rpg", "original"],
        ...
        },
        {
            ...
            description:
                "Фан версия игры DDLC, только с полненькой Моникой, приятной озвучкой в знакомом сеттинге!",
            platform: "Windows",
            year: "2018",
            genres: ["Квест", "Фан версия"],
            categories: ["long", "rpg", "fan"],
        ...
        },
        {
            ...
            description:
                "Подними свой меч и сражай орков, чтобы добыть кровь для своей знойной королевы-вампирши. Но так уж вышло, что кровь орков имеет определенные... «побочные эффекты» для вампиров...",
            platform: "Online",
            year: "2025",
            genres: ["Аркада", "Казуал"],
            categories: ["short", "arcade", "original"],
            author: "merhaps",
        ...
        },
        {
            title: "Feed Rea",
            description:
                "Аркадный кликер, в котором чем больше очков, тем больше становится девушка!",
            platform: "Online",
            year: "2025",
            genres: ["Аркада", "Кликер"],
            categories: ["short", "arcade", "original"],
            author: "BCSstudio",
    ...
    grid.on("click", ".game-card", function () {
        ...
        if (game.downloadLink && game.downloadLink.trim() !== "") {
            $("#modalDownloadLink").attr("href", game.downloadLink).show(); // показать
        } else {
            $("#modalDownloadLink")
                .attr("href", "#") // на всякий случай нейтрализуем
                .hide(); // скрыть
        }
